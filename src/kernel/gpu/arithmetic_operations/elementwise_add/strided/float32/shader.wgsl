...
fn main ([[builtin(global_invocation_id)]] global_id: vec3<u32>) {
	...
	let index_a: u32 = start_position.offset + toIndex(global_id * meta_data.tensor_a_strides);
	let index_b: u32 = start_position.offset + toIndex(global_id * meta_data.tensor_b_strides);
