    ...
    pub fn new<T: bytemuck::Pod>(anchor: &super::PipelineAnchor,
        ...
        let bind_group_layout_0 = device.create_bind_group_layout(
            &wgpu::BindGroupLayoutDescriptor {
                label: Some("Leaky relu derivitice bind group layout 0"),
        ...
        let bind_group_0 = device.create_bind_group(
            &wgpu::BindGroupDescriptor {
                label:  Some("Leaky relu derivitive bind group 0"),
        ...
        let cs_src = include_str!("shaders/leakyreluprime.comp");
        ...
        let compute_pipeline = device.create_compute_pipeline(
            &wgpu::ComputePipelineDescriptor {
                label: Some("Leaky relu derivitive pipeline"),
